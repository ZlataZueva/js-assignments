...
## Javascript Assignments  [![Build Status](https://travis-ci.org/rolling-scopes-school/js-assignments.svg?branch=master)](https://travis-ci.org/ZlataZueva/js-assignments)
...
* Run `git clone https://github.com/ZlataZueva/js-assignments.git` from command line to download the repo.
...
```
* Open https://github.com/ZlataZueva/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/ZlataZueva/js-assignments/builds).
